...
public class canel_booking {
    ...
    public canel_booking(customer cs){
        try{list = cs.view_booking();}catch(SQLException ex){System.out.println("sql error occured cancelbooking");}
        frame =  new JFrame();
